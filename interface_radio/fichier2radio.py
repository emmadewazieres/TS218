...
# Title: Fichier2Radio
# Generated: Fri Sep 28 11:38:11 2018
##################################################
...
class fichier2radio(gr.top_block, Qt.QWidget):
    ...
    def __init__(self, address="serial=EDR10Z6B1", antenna='TX/RX', filename="../sent_spls.bin", freq=868e6, gain=20, samp_rate=1e6):
        ...
        self._variable_gain_win = RangeWidget(self._variable_gain_range, self.set_variable_gain, "variable_gain", "counter_slider", int)
        self.top_layout.addWidget(self._variable_gain_win)
        self._variable_freq_tool_bar = Qt.QToolBar(self)
        self._variable_freq_tool_bar.addWidget(Qt.QLabel('Carrier Frequency'+": "))
        ...
        self.uhd_usrp_sink_0.set_center_freq(variable_freq, 0)
    ...
    def set_variable_freq(self, variable_freq):
        ...
        self.uhd_usrp_sink_0.set_center_freq(self.variable_freq, 0)


def argument_parser():
    parser = OptionParser(usage="%prog: [options]", option_class=eng_option)
    parser.add_option(
        "-a", "--address", dest="address", type="string", default="serial=EDR10Z6B1",
        help="Set File Name [default=%default]")
    parser.add_option(
        "-A", "--antenna", dest="antenna", type="string", default='TX/RX',
        help="Set Antenna [default=%default]")
    parser.add_option(
        "-n", "--filename", dest="filename", type="string", default="../sent_spls.bin",
        help="Set File Name [default=%default]")
    parser.add_option(
